...
# 2. Facebook background aspect ratio is roughly 820x312 (we'll use 2460x936 for ultra high-res 300 DPI)
...
# We want the logo to take up about 45% of the height vertically for Facebook Cover
...
print(f"✅ Successfully created updated Facebook background at: {output_path}")
